/**
 * @file
 * Header: Mlfeaturetensorcoherencelocal
 *
 ...
 */
#ifndef MLFEATURETENSORCOHERENCELOCAL_H
#define MLFEATURETENSORCOHERENCELOCAL_H

#include "mlfeature.h"

class MLFeatureTensorCoherenceLocal : public MLFeature
{
public:
    MLFeatureTensorCoherenceLocal(Channel channel, int arg1);
