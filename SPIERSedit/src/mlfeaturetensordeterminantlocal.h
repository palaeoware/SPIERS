/**
 * @file
 * Header: Mlfeaturetensordeterminantlocal
 *
 ...
 */
#ifndef MLFEATURETENSORDETERMINANTLOCAL_H
#define MLFEATURETENSORDETERMINANTLOCAL_H

#include "mlfeature.h"

class MLFeatureTensorDeterminantLocal : public MLFeature
{
public:
    MLFeatureTensorDeterminantLocal(Channel channel, bool is3D, int arg1);
