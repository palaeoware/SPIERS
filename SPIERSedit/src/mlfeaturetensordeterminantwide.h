/**
 * @file
 * Header: Mlfeaturetensordeterminantwide
 *
 ...
 */
#ifndef MLFEATURETENSORDETERMINANTWIDE_H
#define MLFEATURETENSORDETERMINANTWIDE_H

#include "mlfeature.h"

class MLFeatureTensorDeterminantWide : public MLFeature
{
public:
