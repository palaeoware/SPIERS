/**
 * @file
 * Header: Mlfeaturetensortracelocal
 *
 ...
 */
#ifndef MLFEATURETENSORTRACELOCAL_H
#define MLFEATURETENSORTRACELOCAL_H

#include "mlfeature.h"

class MLFeatureTensorTraceLocal : public MLFeature
{
public:
    MLFeatureTensorTraceLocal(Channel channel, bool is3D, int arg1);
