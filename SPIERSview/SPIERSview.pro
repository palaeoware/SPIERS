...
unix:!macx {
    ...
    #24.04 command is sudo apt-get install libvtk9-qt-dev
    #also need to change spvreader to pre December 29th 2023 version as this has windows commands that will not compile on Linux
    # all below changed to 9.1, and two headers commentedd out

    INCLUDEPATH +=/usr/include/vtk-9.1/
    LIBS += -L/usr/include/vtk-9.1/ \
