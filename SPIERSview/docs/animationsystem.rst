...
.. figure:: _static/figure_5.png
    ...
    Figure 5. Default anatomy of the SPIERSview animation panel
...
The rotations and zoom to be performed in each step are specified in the
...
command - it simply applies the rotations and zoom specified in the
