...
public:
    ...
    QAction *actionSegment_brush_applies_locks;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionSegment_brush_applies_locks = new QAction(MainWindow);
        actionSegment_brush_applies_locks->setObjectName("actionSegment_brush_applies_locks");
        actionSegment_brush_applies_locks->setCheckable(true);
        ...
        menuBrush->addSeparator();
        menuBrush->addAction(actionSegment_brush_applies_masks);
        menuBrush->addAction(actionSegment_brush_applies_locks);
...
#endif // QT_CONFIG(shortcut)
        actionSegment_brush_applies_locks->setText(QCoreApplication::translate("MainWindow", "Segment brush applies locks", nullptr));
