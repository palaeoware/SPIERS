...
AppCopyright=Copyright (C) 2008-2026 by Mark D. Sutton, Russell J. Garwood, and Alan R.T. Spencer
...
[Files]
; Copy all executables and resources from bin directory
; Includes: SPIERSedit64.exe, SPIERSview64.exe, SPIERSalign64.exe, SPIERScrashhandler64.exe
